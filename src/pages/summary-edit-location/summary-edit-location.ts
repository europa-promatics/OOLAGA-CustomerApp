...
export class SummaryEditLocationPage  implements OnInit{
  _1:boolean=false;
  _2:boolean=false;
  _3:boolean=false;
  _4:boolean=false;
  ...
  third_location_name;
  forth_location_name;
  first_location_label='Pick Up';
  second_location_label='Drop off';
  third_location_label='Drop off';
  forth_location_label='Drop off';
  map
            ...
            locationDetails.onDidDismiss(data => {
              if(data==null){
                this.locations_details[value]={
                  ...
                  oolaga_id:localStorage['oolaga_id'],
                  latitude:this.locations_details[value].latitude.toString(),
                  longitude:this.locations_details[value].longitude.toString(),
  ...
  chooseItem(item: any,location_no) {
      ...
      if(location_no==1){
        ...
        let locationDetails = this.modalCtrl.create(FillLocationDetailPage,{location:"FIRST LOCATION DETAILS",location_name:this.first_location_name});
            locationDetails.onDidDismiss(data => {
        ...
        this.appProvider.current.edit_location_data=false;
        let locationDetails = this.modalCtrl.create(FillLocationDetailPage,{location:"SECOND LOCATION DETAILS",location_name:this.second_location_name});
            locationDetails.onDidDismiss(data => {
        ...
        this.appProvider.current.edit_location_data=false;
        let locationDetails = this.modalCtrl.create(FillLocationDetailPage,{location:"THIRD LOCATION DETAILS",location_name:this.third_location_name});
            locationDetails.onDidDismiss(data => {
        ...
        this.appProvider.current.edit_location_data=false;
        let locationDetails = this.modalCtrl.create(FillLocationDetailPage,{location:"FORTH LOCATION DETAILS",location_name:this.forth_location_name});
            locationDetails.onDidDismiss(data => {
  ...
  nextSubmit(){
    ...
    for(let i=0;i<this.locations_details.length;i++){
    ...
    let loader = this.loadingCtrl.create();
        ...
        this.appProvider.current.locations=this.locations_details;
        let oolaga = JSON.parse(localStorage['draftOolaga'])
        if(this.locations_details.length==2){
