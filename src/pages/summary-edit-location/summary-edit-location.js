...
var SummaryEditLocationPage = /** @class */ (function () {
    function SummaryEditLocationPage(appProvider, http, loadingCtrl, modalCtrl, alertCtrl, navCtrl, navParams) {
    ...
    SummaryEditLocationPage.prototype.clearLocation = function (value) {
        ...
        if (value == 0) {
            ...
            this.autocompleteItems4 = [];
            this.forth_location = !this.forth_location;
            this.third_location_label = 'Drop off Location';
            if (this.locations.length == 4) {
                this.locations.pop();
            }
            if (this.locations_details.length == 4) {
    ...
    SummaryEditLocationPage.prototype.editdetail = function (value) {
        var _this = this;
        var locationhead;
        var locationname;
        if (value == 0) {
        ...
        locationDetails.onDidDismiss(function (data) {
            if (data == null) {
                _this.locations_details[value] = {
                    loc_no: value.toString(),
                    oolaga_id: localStorage['oolaga_id'],
                    latitude: _this.locations_details[value].latitude.toString(),
                    longitude: _this.locations_details[value].longitude.toString(),
                ...
                _this.locations_details[value] = {
                    ...
                    curbside: data.curbside ? '1' : '0',
                    inhome: data.inhome ? '1' : '0',
                    stairs: data.stairs.toString(),
    ...
    SummaryEditLocationPage.prototype.loadLocations = function () {
    ...
    SummaryEditLocationPage.prototype.help = function () {
    ...
    SummaryEditLocationPage.prototype.chooseItem = function (item, location_no) {
        var _this = this;
        if (location_no == 1) {
            this._1 = true;
        }
    ...
    SummaryEditLocationPage.prototype.ngOnInit = function () {
        ...
        this.autocompleteItems4 = [];
        var mapEle;
        mapEle = document.getElementById('mapp');
    ...
    SummaryEditLocationPage.prototype.add_next_location = function () {
    ...
    SummaryEditLocationPage.prototype.updateSearch = function (value) {
        var _this = this;
    ...
    SummaryEditLocationPage.prototype.nextSubmit = function () {
        var _this = this;
        console.log('locations_data', this.locations_details);
        for (var i = 0; i < this.locations_details.length; i++) {
            console.log(i, this.locations_details[i]);
        }
        ...
        var oolaga = JSON.parse(localStorage['draftOolaga']);
        if (this.locations_details.length == 2) {
            oolaga.source = this.locations_details[0];
            oolaga.destination = this.locations_details[1];
            oolaga.way_point1 = null;
            oolaga.way_point2 = null;
        }
        if (this.locations_details.length == 3) {
            oolaga.source = this.locations_details[0];
            oolaga.way_point1 = this.locations_details[1];
            oolaga.way_point2 = null;
            oolaga.destination = this.locations_details[2];
        }
        if (this.locations_details.length == 4) {
            oolaga.source = this.locations_details[0];
            oolaga.way_point1 = this.locations_details[1];
            oolaga.way_point2 = this.locations_details[2];
            oolaga.destination = this.locations_details[3];
        }
        localStorage['draftOolaga'] = JSON.stringify(oolaga);
    ...
    SummaryEditLocationPage.prototype.submit = function (value) {
        if (value == 0) {
            this.navCtrl.pop();
        }
        else if (value == 1) {
    ...
    SummaryEditLocationPage.prototype.loadmap = function (value) {
        if (this.markers != null) {
            for (var i = 0; i < this.markers.length; i++) {
                this.markers[i].setMap(null);
            }
    ...
    SummaryEditLocationPage = __decorate([
        Component({
            selector: 'page-summary-edit-location',
            templateUrl: 'summary-edit-location.html'
        }),
    ...
    return SummaryEditLocationPage;
}());
export { SummaryEditLocationPage };
//# sourceMappingURL=summary-edit-location.js.map